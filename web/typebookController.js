/**
 * Created by CANONYANG on 2017/5/6.
 */
/**
 * Created by CANONYANG on 2017/5/3.
 */
var typebook = angular.module('typebook',[]);
typebook.controller('typebookController',function ($scope) {
   /*返回上一页*/
   $scope.type_book_back=function () {
      window.history.back();
   }
   ...
   $scope.typebooks=typebooks;
})

/*star star*/
typebook.directive('star', function () {
   return {
